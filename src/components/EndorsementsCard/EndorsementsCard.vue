      ...
      return {
        ...
        endorsementsData: [
          ...
          // },
          {
            ...
            endorsementInfo: ["违章 2", "罚款 400", "扣分 6"],
            endorsementInfoType: 'warning',
            carStyle: require('./images/carStyle/default.png'),
            restriction: true,
        ...
        switch(serviceType){
          case 1:
            this.$router.push({path: '/manager', query: { lsNum: lsNum, carType: carType, inspection: 0, insurance: 2}}, () => {
              this.$router.push({path: '/insurance', query: { lsNum: lsNum, carType: carType, inspection: 0, insurance: 2, type: 2}})
            })
            break;
          case 2:
            ...
            break;
          case 3:
            this.$router.push({path: '/manager', query: { lsNum: lsNum, carType: carType, inspection: 2, insurance: 2}})
            break;
        }
      }
    },
